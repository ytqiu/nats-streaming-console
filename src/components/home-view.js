    ...
    render() {
        ...
        return (
            <section className="view">
                {clients !== undefined && <NumberWidget number={clients} title="Clients" text="Total Clients" />}
                {channels !== undefined && <NumberWidget number={channels} title="Channels" text="Total Channels" />}
                {subscriptions !== undefined && (
                    <NumberWidget number={subscriptions} title="Subscriptions" text="Active Subscriptions" />
                )}
                {messages !== undefined && <NumberWidget number={messages} title="Messages" text="Total Messages" />}
